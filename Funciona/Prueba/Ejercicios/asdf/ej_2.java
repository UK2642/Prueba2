...
public class ej_2 {
	...
	public static void main(String[] args) {
		//Dada una secuencia de número introducidos por teclado,
		//decir si existen o no números repetidos. La secuencia
		//se acaba cuando introducimos un 0. Puedes asumir que
		//no se introducirán más de 40 números.
